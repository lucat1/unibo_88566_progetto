<template>
  <div class="container" @click="doFlip">
    <div class="card" :class="{ flipped: card.flipped }">
      <img
        v-if="card.name === '8-ball'"
        class="front"
        src="../../assets/8-ball.png"
      />
      <img
      ...
      />
      <img
        v-if="card.name === 'dinosaur'"
        class="front"
        src="../../assets/dinosaur.png"
      />
      <img
        v-if="card.name === 'kronos'"
        class="front"
        src="../../assets/kronos.png"
      />
      <img
        v-if="card.name === 'rocket'"
        class="front"
      ...
      <img
        ...
        class="front"
        src="../../assets/skinny-unicorn.png"
      />
      <img
        v-if="card.name === 'that-guy'"
        class="front"
        src="../../assets/that-guy.png"
      />
      <img
        v-if="card.name === 'zeppelin'"
        class="front"
        src="../../assets/zeppelin.png"
      />
